...
export default function EditListing({ listing, onSubmit }) {
  ...
  const [preview, setPreview] = useState(listing?.image?.url || null)
  ...
  const handleSubmit = async e => {
    ...
    Object.entries(form).forEach(([k, v]) => data.append(`listing[${k}]`, v))
    if (image) data.append('listing[image]', image)
    await onSubmit?.(data)
    toast({ message: 'Listing updated!', type: 'success' })
